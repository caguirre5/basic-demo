    ...
    return (
        <div>
            ...
            <main className=" w-full h-screen flex">
                ...
                <div className="  bg-[#A76734] p-8 w-[60%] flex justify-center">
                    <div className='w-[50%] h-full flex flex-col text-center items-center justify-center'>
                        <h2 className="text-5xl font-avenir-light font-bold mb-8">Did you know?</h2>
                        <p className="text-xl">
            ...
            <main className="relative w-full h-screen flex items-center justify-center bg-[#DEDBD6]">
                ...
                {/* Contenedor de texto */}
                    <div className='w-[35%] h-full flex flex-col ml-20 text-center items-center justify-center'>
                        <h2 className="text-5xl font-bold mb-8 text-[#575F3D]">Every time you give a sip of coffee from Loom,</h2>
                        <p className="text-xl mt-4 text-[#8292A7]">
                            you're, not only changing the life of the people who harvested it, but also, the lives of the people closest to us.
                        </p>
                        <button className="mt-10 text-[#A76734] font-semibold py-2 px-4 border border-[#A76734] rounded-full shadow hover:bg-[#A76734] hover:text-[#DED8D6] focus:outline-none focus:ring-2 focus:ring-[#FFD8CC] focus:ring-opacity-50">
                            MAKE A DIFFERENCE
                        </button>
                    </div>
            </main>
            ...
            <div className="relative overflow-hidden w-full p-4 h-[40vh] text-center flex flex-col items-center justify-center bg-[#575F3D]">
                <p className="text-3xl font-bold w-[25%]">We are a safe place to grow and develop what you believe in.</p>
            ...
            <main className="min-h-screen px-4 py-8 bg-[#DEDBD6] flex flex-col items-center justify-center text-center">
                <h2 className="text-2xl font-bold mb-10 text-[#A76734]">WHAT BE BELIEVE IN</h2>
                <div className="flex justify-center space-x-4 w-full">
                    {/* Autonomy Section */}
                    <div className="w-[16%] flex flex-col justify-center">
                        <img src={M4_autonomyImage} alt="Autonomy" className=" h-[50vh]" />
                        <h3 className="text-2xl font-semibold mt-4 text-[#215A81]">Autonomy</h3>
                        <div className='bg-[#A76734] mx-auto h-1 rounded-full w-28 my-2'/>
                        <p className="text-md text-[#8292A7] mb-2">Everyone works and<br/>acts at their own pace.</p>
                    ...
                    <div className="w-[16%] flex flex-col justify-center items">
                        ...
                        <h3 className="text-2xl font-semibold mt-4 text-[#215A81]">Mastery</h3>
                        <div className='bg-[#A76734] mx-auto h-1 rounded-full w-28 my-2'/>
                        <p className="text-md text-[#8292A7] mb-2">We will all seek<br/>perfection in our art.</p>
                        <button className="mx-auto mt-10 text-[#A76734] font-semibold py-2 px-4 border border-[#A76734] rounded-full shadow hover:bg-[#A76734] hover:text-[#DED8D6] focus:outline-none focus:ring-2 focus:ring-[#FFD8CC] focus:ring-opacity-50">
                            GET TO KNOW US
                        </button>
                    </div>
                    ...
                    <div className="w-[16%] flex flex-col justify-center">
                        ...
                        <h3 className="text-2xl font-semibold mt-4 text-[#215A81]">Purpose</h3>
                        <div className='bg-[#A76734] mx-auto h-1 rounded-full w-28 my-2'/>
                        <p className="text-md text-[#8292A7] mb-2">It’s the glue that<br/>holds us together.</p>
            ...
            >
                <div 
                    className=' h-[70%]'
                    style={{ backgroundImage: `url(${M5_1_bg})` }}
                >
                ...
                >
                    <button className="mx-auto font-semibold py-2 px-4 border border-[#a76834c2] rounded-full shadow bg-[#A76734] text-[#DED8D6] focus:outline-none focus:ring-2 focus:ring-[#FFD8CC] focus:ring-opacity-50">
                        ABOUT LOOM
                    </button>
                </div>
            </main>
            <main className="w-full flex h-screen ">
                ...
                <div  className="relative w-[50%] text-left flex items-center justify-center bg-[#575f3d]">
                    <div  className="w-[60%] text-left flex flex-col items-left justify-center ">
                        <h1 className="text-3xl font-bold mb-12">Let's create <br/> impact together</h1>
                        <div className='my-4'>
                            <p className="text-md m-0 text-[#DEDBD6] mb-2">Phone Number</p>
                            <p className="text-sm m-0 text-[#DEDBD6] mb-2">(123)456-7890</p>
                        </div>
                        <div className='my-4'>
                            <p className="text-md text-[#DEDBD6] mb-2">Email Address</p>
                            <p className="text-sm text-[#DEDBD6] mb-2">hello@loomcofeehouse.com</p>
                        </div>
                        <div className='my-4'>
                            <p className="text-md text-[#DEDBD6] mb-2">CoffeeHouse</p>
                            <p className="text-sm text-[#DEDBD6] mb-2">123 anywhere</p>
                        </div>
